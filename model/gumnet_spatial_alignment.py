...
class GumNetSpatialAlignment(nn.Module):
    """
    Core 2D Transformation Regression and Spatial Warping Module for the GumNet architecture.

    Args:
        input_dim (int, optional): Total number of features after concatenating 
            both bidirectional correlation vectors. Defaults to 8192 (expected 
            for two 4096-dimensional correlation vectors).
    ...
    Examples:
        >>> regressor = TransformationRegressor2D(input_dim=8192)
