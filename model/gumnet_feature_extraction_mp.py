...
class GumNetFeatureExtractionMP(nn.Module):
    """
    Core 2D Feature Extraction Module for the GumNet Siamese architecture with MaxPooling.
    ...
    def __init__(self, in_channels=1):
        super(GumNetFeatureExtractionMP, self).__init__()
        
        # Block 1: 192x192 -> Conv(32-3x3-1-'valid') -> 190x190 -> MaxPooling(2x2x2) -> 95x95
        ...
        # Block 3: 93x93 -> Conv(128-3x3-1-'valid') -> 91x91 -> MaxPooling(2x2x2) -> 45x45
        ...
        # Block 4: 45x45 -> Conv(256-3x3-1-'valid') -> 43x43 -> MaxPooling(2x2x2) -> 21x21
    ...
    def forward(self, x, branch):
        """
        Forward pass through the GumNetMP feature extraction module.
